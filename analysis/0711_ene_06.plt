...
## Last datafile plotted: "0711_hist.txt"
plot "0711_02.dat" using (bin($1, 0.50)):(1.0) smooth freq with boxes title "0711 energy", "0711_hist.txt" using 1:2:(sqrt($2)) with yerrorbars notitle
#    EOF
